...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        'z-10 flex size-12 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] dark:shadow-[0_0_27px_rgb(105,105,105)] dark:bg-[#212121] dark:border-gray-700',
        className
      )}
    >
      {children}
...
export function AnimatedBeamDemo () {
  ...
  return (
    <div
      id="animated-beams"
      className="relative flex h-[340px] w-full items-center justify-center overflow-hidden p-10"
      ref={containerRef}
    >
